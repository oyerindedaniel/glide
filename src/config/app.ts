...
const WORKER_TERMINATION_DELAY = process.env.WORKER_TERMINATION_DELAY
  ? parseInt(process.env.WORKER_TERMINATION_DELAY)
  : 100;

const LIBRARY_WORKER_TERMINATION_DELAY = process.env
  .LIBRARY_WORKER_TERMINATION_DELAY
  ? parseInt(process.env.LIBRARY_WORKER_TERMINATION_DELAY)
  : 200;
