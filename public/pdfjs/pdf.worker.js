...
var AnnotationEditorUIManager = class _AnnotationEditorUIManager {
  ...
  constructor(container, viewer, altTextManager, eventBus, pdfDocument2, pageColors, highlightColors, enableHighlightFloatingButton, enableUpdatedAddImage, enableNewAltTextWhenAddingImage, mlManager, editorUndoBar, supportsPinchToZoom) {
...
var WorkerMessageType = /* @__PURE__ */ ((WorkerMessageType2) => {
  WorkerMessageType2["InitPDF"] = "init-pdf";
  WorkerMessageType2["PDFInitialized"] = "pfd-initialized";
  WorkerMessageType2["ProcessPage"] = "process-page";
  WorkerMessageType2["PageProcessed"] = "page-processed";
...
self.onmessage = async (e) => {
  try {
    switch (e.data.type) {
      case "init-pdf" /* InitPDF */:
        try {
          console.log("---------her you see");
          pdfDocument = await __webpack_exports__getDocument({ data: e.data.pdfData }).promise;
          console.log("after yousee youd");
          self.postMessage({
            type: "pfd-initialized" /* PDFInitialized */,
      ...
      case "process-page" /* ProcessPage */:
        ...
        const response = {
          type: "page-processed" /* PageProcessed */,
          pageNumber,
          blob,
    ...
    const response = {
      type: "error" /* Error */,
      error: errorMessage,
      pageNumber: e.data.type === "process-page" /* ProcessPage */ ? e.data.pageNumber : void 0
    };
